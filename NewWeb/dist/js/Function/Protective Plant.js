 ...
 // 这里利用AJAX的GET方法获取植物总数以及各类信息
  ...
  $.get("../../After/PHP/Protective Plant.php",function(data,status){
    ...
    for (var i = 0; i <= Max-1; i++) {
        ...
        var Baohujibie=Row.insertCell(0);
        ...
        Baohujibie.innerHTML=myArr[i+1].baohujibie.split(",")[1];
...
//得用AJAX的POST把点击的植物传给服务器，最后返回结果并打开新网页
    ...
    $.ajax({
      ...
      url:"../../After/PHP/Click Protective.php",
